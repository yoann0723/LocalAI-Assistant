...
set(OUTPUT_DIR "${DEV_OUTPUT_DIR}")
set(qmldir_param "--qmldir" "${QML_DIR}")

if (OS_WINDOWS)
	if (EXISTS "${OUTPUT_DIR}/${TARGET}.exe")
		message(STATUS "Found executable: ${OUTPUT_DIR}/${TARGET}.exe, QML_DIR=${QML_DIR}")
		execute_process(COMMAND "${QT_DIR}/bin/windeployqt.exe" "${OUTPUT_DIR}/${TARGET}.exe" ${qmldir_param} --no-translations)
	elseif (EXISTS "${OUTPUT_DIR}/${TARGET}.dll")
		message(STATUS "Found DLL: ${OUTPUT_DIR}/${TARGET}.dll")
	...
	elseif (EXISTS "${OUTPUT_DIR}/bin/64bit/${TARGET}.exe")
		message(STATUS "Found executable: ${OUTPUT_DIR}/bin/64bit/${TARGET}.exe")
	...
	elseif (EXISTS "${OUTPUT_DIR}/bin/64bit/${TARGET}.dll")
		message(STATUS "Found DLL: ${OUTPUT_DIR}/bin/64bit/${TARGET}.dll")
